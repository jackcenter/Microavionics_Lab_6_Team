...
#define _XTAL_FREQ 16000000     //Using 16 MHz oscillator clock
...
void DisplayC( const char *LCDStr ) {
    ...
    strcpy(temp,LCDStr); // Create copy from program memory to data memory variable temp
    DisplayV(temp);      // Calling DisplayV function to display temp
}
